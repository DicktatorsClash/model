...
#
# # Load DistilBERT tokenizer and pretrained model
# tokenizer = DistilBertTokenizer.from_pretrained("distilbert-base-uncased")
# distilbert_model = TFDistilBertForSequenceClassification.from_pretrained("best_model_llm_v3")
#
...
#
# # Save the best model
# distilbert_model.save_pretrained("best_model_llm_v4")
#
# # Function to classify text
# def classify_text(text):
#     inputs = tokenizer(text, return_tensors='tf', truncation=True, padding=True, max_length=128)
...
# Load DistilBERT tokenizer and pretrained model
tokenizer = DistilBertTokenizer.from_pretrained("distilbert-base-uncased")
distilbert_model = TFDistilBertForSequenceClassification.from_pretrained("../../../best_bert_model")
